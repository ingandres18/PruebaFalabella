...
namespace PruebaFalabella.Controllers
{
    public class AsesorController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PrimerNombre,SegundoNombre,PrimerApelldo,SegundoApellido,Correo,FechaNacimiento")] Asesor asesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PrimerNombre,SegundoNombre,PrimerApelldo,SegundoApellido,Correo,FechaNacimiento")] Asesor asesor)
        {
            if (ModelState.IsValid)
            {
